...
class JapamTimerService : Service() {
    ...
    companion object {
        const val CHANNEL_ID = "japam_timer_v2"
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        if (intent?.action == ACTION_START) {
            ...
            completedLoops = intent.getIntExtra(EXTRA_COMPLETED, 0)
            totalLoops = intent.getIntExtra(EXTRA_TOTAL, 1)
    ...
    private fun buildNotification(remainingMs: Long): Notification {
        ...
        val malaLabel = "Mala ${completedLoops + 1} / $totalLoops"
    ...
    private fun handleLoopComplete() {
        ...
        val newCompleted = completedLoops + 1
