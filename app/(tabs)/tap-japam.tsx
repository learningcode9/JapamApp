...
export default function JapamMain() {
  ...
  // never unmounts across a sign-out/sign-in cycle (Tap Japam is a persistent tab, and sign-in/out
      ...
      try {
        ...
        if (url && key) {
          ...
          const res = await fetch(
            `${url}/rest/v1/japam_history?user_id=eq.${encodedUserId}&select=created_at,malas,count,user_name,completion_id,japam_name&order=created_at.asc`,
